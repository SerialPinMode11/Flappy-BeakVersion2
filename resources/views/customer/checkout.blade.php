            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <form id="payment-form">
                    <div class="mb-4">
                        ...
                        <select id="payment-method" name="payment-method" class="w-full p-2 border rounded-md focus:ring-primary focus:border-primary" required>
                    ...
                    <div id="online-payment-options" class="mb-4" style="display: none;">
                        ...
                        <select id="online-payment-method" name="online-payment-method" class="w-full p-2 border rounded-md focus:ring-primary focus:border-primary">
                    ...
                    <div id="reference-number-input" class="mb-4" style="display: none;">
                        ...
                        <input type="text" id="reference-number" name="reference-number" class="w-full p-2 border rounded-md focus:ring-primary focus:border-primary" placeholder="Enter reference number">
                    </div>
                    ...
                    <button type="submit" id="submit-btn" class="w-full bg-primary text-white px-6 py-3 rounded-full hover:bg-primary-dark transition-colors">
                        Pay Now
                    </button>
                </form>
            </div>
